...
# download data
download.file(url = "https://s3.amazonaws.com/assets.datacamp.com/blog_assets/prince_raw_data.csv", 
              destfile = "C:/Users/ahpvi/Documents/cursos/text_mining/lyrics/prince_raw_data.csv")
...
prince <- prince_orig %>% 
      dplyr::select(lyrics = text, song, year, album, peak, 
             us_pop = US.Pop, us_rnb = US.R.B)

str(prince[139, ]$lyrics, nchar.max = 300) # looking at the struct of one of the songs
...
#' his most prolific decade for new songs was the 1990s, yet more chart 
#' hits occurred in the 1980s. Why is this the case? Keep this question in 
#' mind as you walk through the sections on text mining.
...
#' Prince wrote hundreds of songs for which there is no release date in the
#' data. For sentiment analysis or exploratory analysis you can use all 
#' the data, but for trends over time you have a much smaller set to work 
#' with. This is OK - just something to keep in mind.
...
# snapshot: picked one word and limited its appearance in 10 songs
...
# https://www.surveygizmo.com/resources/blog/qualitative-data-word-cloud/
